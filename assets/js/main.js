...
window.addEventListener('DOMContentLoaded', (event) => {
    ...
    interactables.forEach(function(interactable) {
      if (interactable.id === "info") {
        interactable.addEventListener("click", function (evt) {
          alert(
            "Bienvenido a mi espacio de trabajo en relación a la construcción de metaversos, explora la casa para ver mis trabajos al día 1/6/2023, saludos! Diego Soria."
          );
        });
      } else if (interactable.id === "logoDev") {
        interactable.addEventListener("click", function (evt) {
          location.href = "https://soriadev.netlify.app/";
        });
      } else if (interactable.id === "bannerDev") {
        interactable.addEventListener("click", function (evt) {
          location.href = "https://www.facebook.com/SoriaDev";
        });
      } else if (interactable.id === "meteoro") {
        interactable.addEventListener("click", function (evt) {
          location.href = "https://aframemeteoro.netlify.app/";
        });
      } else if (interactable.id === "world") {
        interactable.addEventListener("click", function (evt) {
          location.href = "https://globalsoriadev.netlify.app/";
        });
      }
